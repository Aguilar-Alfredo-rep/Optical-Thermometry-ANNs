# TEMPERATURE PREDICTION (CNN) FOR MULTIPLE SPECTRA (FOLDER)
...
SPEC_DIR      = "Espectros_rename"   # dir. with 1.csv, 2.csv, 4.csv, ...
...
# lista de espectros (orden numérico si el nombre es "N.csv")
...
##########################################################################
# output
out = pd.DataFrame(rows, columns=["spectrum", "T_pred_C", "T_corr_C"])
